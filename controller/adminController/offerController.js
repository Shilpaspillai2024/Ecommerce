...
const addOfferPost = async (req, res) => {
    try {
        ...
        if (offerTarget === 'CATEGORY') {
            ...
            const bulkOperations = productUnderCategory.map(product => ({
                updateOne: {
                    ...
                    update: {
                        ...
                        productDiscountPrice: product.productPrice * (1 - (discountAmount / 100))
                    }
                }
            }));
            ...
            req.flash('errorMessage', `Offer added for the products  ${product.productName}`);
            ...
            product.productDiscount = discountAmount,
                ...
                product.productDiscountPrice = product.productPrice * (1 - (discountAmount / 100))
    ...
    try {
        ...
        if (offerDetails.offerFor === 'PRODUCT') {
            offerDetails.offerProductId.productDiscount = 0,
                offerDetails.offerProductId.productDiscountPrice = offerDetails.offerProductId.productPrice
    ...
    try {
        ...
        if (offerDetails.offerFor === 'PRODUCT') {
            if (offerDetails.offerProductId) {
                ...
                offerDetails.offerProductId.productDiscountPrice = offerDetails.offerProductId.productPrice * (1 - editDiscountPercent / 100);
            ...
            const bulkOperations = productUnderCategory.map(product => ({
                updateOne: {
                    ...
                    update: {
                        ...
                        productDiscountPrice: product.productPrice * (1 - (editDiscountPercent / 100))
                    }
                }
            }));
